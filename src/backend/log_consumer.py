...
class KafkaLogConsumer:
    def __init__(self, user: str, pswd: str, host: str, port: int, database_name: str, kafka_bootstrap_servers: str, consumer_group: str, kafka_topic: str) -> None:
        self.user = user
        self.pswd = pswd
        self.host = host
        self.port = port
        ...
        self.db = Database(user, pswd, host, port, database_name)
